...
const ConsulterFinancement = () => {
    ...
    return (
        <div className="content">
            <Card>
                <CardHeader>
                    <h4 className="title">Détails de la financement</h4>
                </CardHeader>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-primary">
                                        ...
                                        <div className="card-body">
                                            <p><strong>Numéro PO :</strong> {facture.numPO}</p>
                                            <p><strong>Date de récéption :</strong> {facture.dateRec}</p>
                                            <p><strong>Montant :</strong> {facture.montant}</p>
                                            <p><strong>Devise :</strong> {facture.devise}</p>
                                            <p><strong>Fichier :</strong> {facture.file}</p>
                                            <p><strong>Destination :</strong> {facture.dest}</p>
                                            <p><strong>Echeance :</strong> {facture.ech}</p>
                                            <p><strong>Objet :</strong> {facture.objet}</p>
                                            <p><strong>Financement :</strong> {facture.fncm}</p>
                                            <p><strong>Date PO :</strong> {facture.datepo}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default ConsulterFinancement;
