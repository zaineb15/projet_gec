...
const ConsulterDevise = () => {
    ...
    return (
        <div className="content">
            <Card>
                <CardHeader>
                    <h4 className="title">Détails de la devise</h4>
                </CardHeader>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-primary">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p><strong>Delai de paiement :</strong> {facture.delaiPaiement}</p>
...
export default ConsulterDevise;
