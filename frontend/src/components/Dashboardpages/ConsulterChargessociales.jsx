...
const Consulterchargesociale = () => {
    ...
    return (
        <div className="content">
            <Card>
                <CardHeader>
                    <h4 className="title">Détails de la charge sociale</h4>
                </CardHeader>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-primary">
                                        ...
                                        <div className="card-body">
                                            <p><strong>Numéro PO :</strong> {facture.numero_op}</p>
...
export default Consulterchargesociale;
